...
all_sites_plot <- function(park, site_list, char){
  ...
  lineplot <- 
    ...
    geom_point(aes(group = sitename, color = sitename, 
                   ...
                   size = 2) +
    scale_color_manual(values = c("#3288bd", "#000000"), labels = sitename, name = NULL) +
...
```{r, site_1, echo = F, warning = F, message = F, fig.height=6, out.width='100%'}
...
These sites definitely exist! This section should include site descriptions and potentially a map. 
