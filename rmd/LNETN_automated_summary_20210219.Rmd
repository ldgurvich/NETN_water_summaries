...
for(i in seq_along(site_list)){
  ...
  fig_cap_p <- htmltools::withTags(body('The plots below show historic ranges for', site_name, 
                                        ...
                                        WQ thresholds are derived from state surface water quality 
                                        standards. See "About the Data" for more details.'))
  ...
  fig_cap_n <- htmltools::withTags(body('The boxplots below show historic ranges for', site_name, 
                                        ...
                                        measurements collected in', current, 'by month. WQ thresholds are 
                                        derived from state surface water quality standards. 
