...
for(i in seq_along(site_list)){
  ...
  fig_height <- ifelse(num_plots_p > 4, 6.5, 4.5)
  fig_width <- 9.3
...
##------------------------------------------------------------------------------
  ...
  find_ctv <- data.frame(ctv = lapply(seq_along(subplots_n$x$data),
    function(i){
      if(subplots_n$x$data[[i]]$name == "Current value"){
        paste0(i)
        } else{NA}
      } ) %>% unlist()) %>%
      na.omit() %>% slice(1) %>% as.numeric()
...
##------------------------------------------------------------------------------
  ...
  # Create tab chunk templates
    ...
    template <- paste0(
      ...
      "## {{site_name}}{.tabset}\n",
      "### Physical\n",
      "```{r {{site_p}}, fig.height=",fig_height, ", fig.width=", fig_width,", echo = FALSE}\n",
      "plot_title\n",
      "\n",
      "fig_cap_p\n",
      "subplots_p\n",
      ...
      "\n",
      "### Nutrients\n",
      "```{r {{site_n}}, fig.height=",fig_height, ", fig.width=", fig_width,", echo = FALSE}\n",
      "plot_title\n",
      "\n",
      "fig_cap_n\n",
      "subplots_n\n",
