...
<h3>References</h3>
<a href="https://www.nps.gov/im/netn/water-quality-quantity-monitoring.htm">Water Quality & Quantity Monitoring in Northeast Temperate Network Parks</a>
...
```{r irma_link, results='asis'}
irma <- data.frame(park = c("ACAD","MABI","MIMA","MORR","ROVA","SAGA","SAIR","SARA","WEFA"),
                   code = c("1122","1062","1103","1138","1146","1159","1153","1168","1176")) %>% 
  filter(park == parkcode)

htmltools::withTags(p(a(href=paste0("https://irma.nps.gov/DataStore/SavedSearch/Profile/", irma$code), title="IRMA Data Store", "Water Quality Reports")))
