...
state <- case_when(
  park == "MIMA" | park == "SAIR" ~ "MA",
  park == "ROVA"| park == "SARA" ~ "NY",
  park == "ACAD" ~ "ME",
  park == "MABI" ~ "VT",
  park == "MORR" ~ "NJ",
  park == "SAGA" ~ "NH",
...
```{r sample_collection, results='asis', include = nutrients}
...
```{r nutrients, results='asis', include = nutrients}
