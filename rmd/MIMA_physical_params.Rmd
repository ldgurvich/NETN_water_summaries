...
all_sites_plot <- function(park, site_list, char){
  ...
  lineplot <- 
    ...
    geom_point(aes(group = sitename, color = sitename, 
                   ...
                   size = 2) +
    scale_color_manual(values = colors, labels = sitename, name = NULL) + #added third color and shape
    scale_shape_manual(values = shapes, labels = sitename, name = NULL)+                         #for MIMA
    forestMIDN::theme_FVM() +
    labs(y = ylabel, x = NULL, title = NULL)+
