...
fig_cap_comp_n <- htmltools::withTags(body(
                          ...
                          current, 'field season. Only water quality parameters
                          that are measured at multiple sites are included. WQ thresholds
                          established by the EPA based on the lower 25th percentile of sites 
                          with existing data. Parameter 
                          abbreviations and additional information are defined in
                          "About the Data".'))
...
for(i in seq_along(site_list_lake)){
  ...
  fig_cap_n <- htmltools::withTags(body('The boxplots below show historic ranges for', site_name, 
                                        ...
                                        measurements collected in', current, 'by month. WQ thresholds were 
                                        established by the EPA based on the lower 25th percentile of lakes 
                                        with existing data. 
...
for(i in seq_along(site_list_stream)){
  ...
  fig_cap_n <- htmltools::withTags(body('The boxplots below show historic ranges for', site_name, 
                                        ...
                                        outliers. The points represent the most recent 
                                        measurements collected in', current, 'by month. WQ thresholds were 
                                        established by the EPA based on the lower 25th percentile of streams 
                                        with existing data.  
                                        Parameter abbreviations and additional information are defined in
                                        "About the Data".'))
