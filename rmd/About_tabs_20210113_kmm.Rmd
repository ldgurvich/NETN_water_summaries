...
Water quality thresholds represent the lower 5th percentile of reference waters in the region, and separate moderate from most disturbed sites. "Least disturbed" thresholds below represent the 75th percentile of sites. 
...
note <- htmltools::withTags(p(em("Note: When state water quality standards are not defined, EPA water quality thresholds are used (see EPA Ecoregional Nutrient Criteria tables above).")))
...
htmltools::withTags(p(em("Note: When state water quality standards are not available, EPA water quality thresholds are used (see table above).")))
