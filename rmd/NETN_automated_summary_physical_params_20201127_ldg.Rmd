...
fig_cap <- htmltools::withTags(body(
                          strong('About the figure:'), 'The above plots compare monthly
...
for(i in seq_along(site_list)){
  ...
  plot_title <- htmltools::withTags(h2('Monthly Water Quality Measurements', 
                                                paste0('(', site_name, ', ', current, ')')))
                                                 
  fig_cap <- htmltools::withTags(body(strong('About the figure:'), 'The above plots show historic ranges
...
markerLegendHTML <- function(IconSet) {
    ...
    <h4 style='padding-top:0; padding-bottom:10px; margin: 0;'> Legend </h4>"
