...
water_icon <- makeAwesomeIcon(icon = "waterdrop",
...
leaflet() %>%
  ...
  #            #                                          "font-weight" = "bold")),
  #            fillOpacity = 0.9,
  #            fillColor = ifelse(water_sites$type == "Stream", "blue", "gray"), # fill can be dynamic, based on stream/lake
  ...
  # addLegend(position = "bottomleft", colors = c("blue", "gray"), labels = water_sites$type)

```

### Site Map awesome marker legend
```{r, leaflet, out.width="100%", message=F}
...
IconSet <- awesomeIconList(
  ...
  "Lake" = makeAwesomeIcon(icon= 'waterdrop', markerColor = 'gray', iconColor = 'white', library = "ion")
)
