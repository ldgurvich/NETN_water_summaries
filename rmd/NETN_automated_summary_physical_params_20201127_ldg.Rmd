...
# stink <- makeIcon(
#   iconUrl = 'C:/Users/Diana/Pictures/stink.png',
#   iconWidth = 38, iconHeight = 94,
#   iconAnchorX = 22, iconAnchorY = 94
# )

icon.ion <- makeAwesomeIcon(icon = "waterdrop", markerColor = "blue",
                            iconColor = "white",
                            library = "ion")
...
leaflet() %>%
    ...
    addAwesomeMarkers(data = water_sites, ~long, ~lat, icon=icon.ion, 
                      label=as.character(water_sites$SiteName),
                      popup = htmlEscape(water_sites$SiteName))
