  ...
  print(tagList(  
          ...
          subplot(plot_list[names(plot_list) == site][1:num_plots],
            ...
            layout(autosize = FALSE,
              ...
              layout(images = 
             list(
               source = base64enc::dataURI(file = 
                 "./images/water_legend_wide_pwq.png",
               ),
               visible = TRUE,
               x = ifelse(num_plots > 4, 0.55, 0), 
               y = ifelse(num_plots > 4, 0.23, -0.165),
               layer = 'above',
               resolution = 600,
               #sizing = 'stretch',
               sizey = ifelse(num_plots > 4, 0.2, 0.348),
               sizex = ifelse(num_plots > 4, 0.5, 0.87),
